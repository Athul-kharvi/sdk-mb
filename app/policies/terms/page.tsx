    ...
    <PolicyLayout
      ...
      sections={[
        ...
        },
        {
          ...
          body: 'One-gram gold jewellery requires proper care to maintain its finish. We provide care instructions with each order. Damage caused by improper care, exposure to chemicals (perfumes, cleaning agents), or physical impact is not covered under our return policy.',
        },
        {
